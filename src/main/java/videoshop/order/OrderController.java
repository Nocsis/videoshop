...
class OrderController {
	...
	@PostMapping("/remItem")
	String remove(@RequestParam("name") String name, @ModelAttribute Cart cart) {

		// Wir löschen die jeweilige Disc aus dem Warenkorb.
	...
	String clear(@ModelAttribute Cart cart) {
		...
		//Wir löschen alle Items aus dem gegebenen Cart
		cart.clear();
